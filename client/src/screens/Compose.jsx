    ...
    <div className='w-full h-screen flex flex-col justify-center'>
        ...
        <div className='max-w[1240px] m-auto px-40 text-white z-10'>
            <div className='flex flex-col md:flex-row md:items-center'>
                ...
                <h1 className='text-2xl font-bold'>Şu anki ruh haliniz yazmaya başladığınız şarkıyı büyük ölçüde etkileyecektir. Zihninizi boşaltın ve nasıl hissettiğinize odaklanın. </h1>
            </div>
