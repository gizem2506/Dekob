...
import bgImg from "../assets/manzara18.jpg"
    ...
    <div className='w-full h-screen flex flex-col justify-center'>
        ...
        <div className='max-w[1240px] m-auto px-10 md:px-40 text-white z-10'>
            <div className='flex flex-col md:flex-row md:items-center mb-5 mx-5 md:mx-0'>
                ...
                <h1 className='text-lg md:text-2xl font-bold'>Zihninin boş olacağı bir ortamde düşünmek ister misin?</h1>
            </div>
            <p className='text-white mx-5 mb-2'>İşte sana ilham verebilecek ortamlarımız!</p>
