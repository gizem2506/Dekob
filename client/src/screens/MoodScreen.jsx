...
function MoodScreen() {
  return (
    <div className='w-full h-full flex flex-col justify-center'>
        ...
        <div className='max-w[1240px] my-10 mx-10 px-5 lg:mx-40 lg:px-20 bg-content bg-opacity-30 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl backdrop-filter-blur'>
