    ...
    <div className='w-full h-screen flex flex-col justify-center'>
        ...
        <div className='max-w[1240px] m-auto px-40 text-white z-10'>
            <div className='flex items-center mb-5'>
                ...
                <h1 className='text-2xl font-bold'>Hata yapmaktan korkma, en saçma fikirler sana ilham olabilir ve harikalar yaratabilirsin. Hemingway’in de dediği gibi, sarhoşken yazın, ayıkken düzeltin.</h1>
            </div>
